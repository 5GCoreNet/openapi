...
// checks if the ExternalGnbCuUpFunctionSingle type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ExternalGnbCuUpFunctionSingle{}
