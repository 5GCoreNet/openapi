...
func (o MediaStreamingAccessRecord) ToMap() (map[string]interface{}, error) {
	...
	serializedBaseRecord1, errBaseRecord1 := json.Marshal(o.BaseRecord1)
	if errBaseRecord1 != nil {
		return map[string]interface{}{}, errBaseRecord1
	}
	errBaseRecord1 = json.Unmarshal([]byte(serializedBaseRecord1), &toSerialize)
	if errBaseRecord1 != nil {
		return map[string]interface{}{}, errBaseRecord1
	}
