...
// checks if the NetworkSliceSubnetSingleAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkSliceSubnetSingleAllOf{}
