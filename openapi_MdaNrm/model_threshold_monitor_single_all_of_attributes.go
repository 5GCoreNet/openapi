...
// SetThresholdInfoList gets a reference to the given []ThresholdInfo1 and assigns it to the ThresholdInfoList field.
func (o *ThresholdMonitorSingleAllOfAttributes) SetThresholdInfoList(v []ThresholdInfo1) {
