...
// APIClient manages communication with the EES Session with QoS API API v1.1.0-alpha.1
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.IndividualSessionWithQoSDocumentApi = (*IndividualSessionWithQoSDocumentApiService)(&c.common)
	c.SessionsWithQoSCollectionApi = (*SessionsWithQoSCollectionApiService)(&c.common)
