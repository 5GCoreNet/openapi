...
// checks if the TopAttr type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TopAttr{}
...
func (o TopAttr) ToMap() (map[string]interface{}, error) {
