...
func (o EeSubscriptionExt) ToMap() (map[string]interface{}, error) {
	...
	serializedEeSubscription, errEeSubscription := json.Marshal(o.EeSubscription)
	if errEeSubscription != nil {
		return map[string]interface{}{}, errEeSubscription
	}
	errEeSubscription = json.Unmarshal([]byte(serializedEeSubscription), &toSerialize)
	if errEeSubscription != nil {
		return map[string]interface{}{}, errEeSubscription
	}
