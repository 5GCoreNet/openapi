...
// APIClient manages communication with the ECS Target EES Discovery API API v1.1.0-alpha.1
...
type APIClient struct {
	...
	EESProfilesCollectionApi *EESProfilesCollectionApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.EESProfilesCollectionApi = (*EESProfilesCollectionApiService)(&c.common)
