...
// checks if the MLTrainingProcessSingleAllOfAttributes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MLTrainingProcessSingleAllOfAttributes{}
...
func NewMLTrainingProcessSingleAllOfAttributes() *MLTrainingProcessSingleAllOfAttributes {
	this := MLTrainingProcessSingleAllOfAttributes{}
	return &this
}

// NewMLTrainingProcessSingleAllOfAttributesWithDefaults instantiates a new MLTrainingProcessSingleAllOfAttributes object
...
func (o *MLTrainingProcessSingleAllOfAttributes) GetPriority() int32 {
...
func (o *MLTrainingProcessSingleAllOfAttributes) HasPriority() bool {
	if o != nil && !IsNil(o.Priority) {
		return true
	}
...
func (o *MLTrainingProcessSingleAllOfAttributes) SetPriority(v int32) {
	o.Priority = &v
}
...
func (o *MLTrainingProcessSingleAllOfAttributes) GetProgressStatus() TrainingProcessMonitor {
...
// and a boolean to check if the value has been set.
func (o *MLTrainingProcessSingleAllOfAttributes) GetProgressStatusOk() (*TrainingProcessMonitor, bool) {
	if o == nil || IsNil(o.ProgressStatus) {
		return nil, false
	}
...
func (o *MLTrainingProcessSingleAllOfAttributes) SetProgressStatus(v TrainingProcessMonitor) {
	o.ProgressStatus = &v
}
...
type NullableMLTrainingProcessSingleAllOfAttributes struct {
	value *MLTrainingProcessSingleAllOfAttributes
	isSet bool
}

func (v NullableMLTrainingProcessSingleAllOfAttributes) Get() *MLTrainingProcessSingleAllOfAttributes {
	return v.value
}

func (v *NullableMLTrainingProcessSingleAllOfAttributes) Set(val *MLTrainingProcessSingleAllOfAttributes) {
	v.value = val
	v.isSet = true
}

func (v NullableMLTrainingProcessSingleAllOfAttributes) IsSet() bool {
	return v.isSet
}

func (v *NullableMLTrainingProcessSingleAllOfAttributes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMLTrainingProcessSingleAllOfAttributes(val *MLTrainingProcessSingleAllOfAttributes) *NullableMLTrainingProcessSingleAllOfAttributes {
	return &NullableMLTrainingProcessSingleAllOfAttributes{value: val, isSet: true}
}

func (v NullableMLTrainingProcessSingleAllOfAttributes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMLTrainingProcessSingleAllOfAttributes) UnmarshalJSON(src []byte) error {
	v.isSet = true
