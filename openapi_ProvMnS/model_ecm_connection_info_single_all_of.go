...
// checks if the EcmConnectionInfoSingleAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EcmConnectionInfoSingleAllOf{}
