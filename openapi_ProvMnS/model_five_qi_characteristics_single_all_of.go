...
// checks if the FiveQICharacteristicsSingleAllOf type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FiveQICharacteristicsSingleAllOf{}
